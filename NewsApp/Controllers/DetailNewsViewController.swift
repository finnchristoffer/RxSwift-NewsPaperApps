...
class DetailNewsViewController: UIViewController {
    ...
    private func setupConstraints() {
        ...
        newsImageView.anchor(top: titleLabel.bottomAnchor, left: scrollView.leftAnchor, right: scrollView.rightAnchor, paddingTop: 5, paddingLeft: 15, paddingRight: 15, width: 350, height: 300)
